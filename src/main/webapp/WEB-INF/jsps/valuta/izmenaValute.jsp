<%-- 
    Document   : izmenaValute
    Created on : May 21, 2016, 5:54:46 PM
    Author     : Andreja
--%>
...
<div class="list-group">
    <div class="list-group-item">
        <b><a href="valuta/prikazValute">Valuta</a> / Izmena</b>
    </div>
</div>

<form action="valuta/izmenaValute/${valuta.naziv}" method ="post" class='form-horizontal'>
